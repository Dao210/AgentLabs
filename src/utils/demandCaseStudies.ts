...
export const demandCaseStudies: DemandCaseStudy[] = [
  ...
  },
  {
    ...
    feasibility: 16, //根据供给和需求计算可行性
    successRate: 78,
    analysisDate: "2019-08-06",
    tags: ["文化", "哲学", "教育", "北美市场", "东方智慧"],
    googletrends: '100',
    pageresults: '6.78M'
  },
  ...
  },
  {
    ...
    userAnalysis: "核心用户：10-18岁青少年（小学高年级至高中阶段学生），他们具有较强的求知欲和探索精神，需要个性化学习路径和实践机会。次要用户：学生家长、学校教师，家长关注孩子综合素质发展，教师需要高效的教学工具和资源支持。",
    currentSupply: "现有供给严重不足：1) 传统PBL实施依赖教师个人能力，缺乏系统性平台支持；2) 缺乏AI个性化指导，无法实现因材施教；3) 项目设计缺乏真实性和时代性，难以激发学生兴趣；4) 评价体系单一，无法全面反映学生核心素养发展；5) 缺乏跨学科整合能力，难以实现知识的综合应用。",
    feasibility: 10,
    successRate: 74,
    analysisDate: "2024-12-28",
    tags: ["PBL", "AI", "青少年学习"],
